package cn.xmut.edu.gamestay.pojo.vo;
...
public class ResultVO<T> {
    ...
    public ResultVO success(Object data, String msg) {
        return new ResultVO(HttpCodeEnum.REQUEST_SUCCESS.getCode(), data, msg);
    }

    public ResultVO success(Object data) {
        return new ResultVO(HttpCodeEnum.REQUEST_SUCCESS.getCode(), data, "");
    }
